        ...
        try{
            ...
            while(clients.hasNext()){
                ...
                try {
                    ...
                    //Log key if appID=1.
                    if (appID == 1) {
                        Utils.printToLog(HecticusProducer.class, "Hecticus producer - TVMAX", "DEBUG: Evento: \"" + msg + "\" - Cliente key: " + key, true, ex, "support-level-1", Config.LOGGER_ERROR);
                    }
                    Utils.printToLog(HecticusProducer.class, "Hecticus producer - Other Apps", "No se enviara el evento \"" + msg + "\" al cliente " + key, false, ex, "support-level-1", Config.LOGGER_ERROR);
                }
            }
            processEvent();
        }catch (Exception e){
